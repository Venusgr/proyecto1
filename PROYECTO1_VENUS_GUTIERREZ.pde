PGraphics foo,foo2, foo3, foo4,foo5;
PGraphics bar,bar1,bar2,bar3;
PImage fondo, fondo1, fondo2, Instructions,Inicio, mensajefinal, mensajefinal2;
PFont p1, p2,p4;
int x,y, inicio, turno, pantalla=0, boxSizeX=140, boxSizeY=50, P1=0, hitS=0, hitL=0,fin=0;
void setup()
{
  size(800,600);
...
void draw()
{
  switch(pantalla)
  {
    ...
    case 2: //Juego
      ...
      foo5.endDraw();
      image(foo5,550,30);
      //Cantidad de golpes (10 para ganar)      
      if (hitS==10)
      {
